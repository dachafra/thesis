...
From a more general perspective, the achievements and conclusions of this thesis are:
\begin{itemize}
    \item \textbf{Heterogeneity in mapping specifications is a benefit, not a problem.}
    \item \textbf{Pre-processing and data cleaning steps need more attention.}
    \item \textbf{Scalability is still an issue in KG construction.}
    \item \textbf{Virtual KG construction approaches are immature.}
