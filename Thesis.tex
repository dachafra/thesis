...
\ifpdf  
    \pdfinfo { /Title  (Non sei que titulo vou poñer ainda)
               /Creator (TeX)
               /Producer (pdfTeX)
...
%\title{A Semantic-Based Approach to Problem-Based Learning}
...
% But take care that the paths match. You can also change the order of appearance by moving the include commands.
 ...
 % Part I
\input{1_introduction/introduction}	% IoT and Fog technolgy stack, Challenges of controlling these environments (RCA and performance)
										% Hypothesis and objectives, organisation of the manuscript 

%\part{Context: The IoT technological stack and its management}
...
\input{5_enhancingaccess/access}

\input{6_kgconstruction/construction}


\input{7_benchmark/benchmark}
% question. Should we include here state of the art on AI??

%\include{7_protocols/protocols}
%\include{8_implementation/implementation}

%\part{Managing, optimising and monitori ng the IoT stack}

%\input{8_evaluation/evaluation.tex}



\input{9_conclusions/conclusions}
