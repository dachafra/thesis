...
\begin{figure}[t]
    \centering
    \includegraphics[width=1\linewidth]{figures/best-dist.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=1\linewidth]{figures/worst-dist.pdf}
