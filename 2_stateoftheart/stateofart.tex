...
Based on & - & R2RML & R2RML and RML & SPARQL & ShEx \\ \hline
\begin{tabular}[c]{@{}l@{}}Transformation\\ Functions\end{tabular} & - & \begin{tabular}[c]{@{}c@{}}Function \\ Ontology\end{tabular} & - & \begin{tabular}[c]{@{}c@{}}SPARQL \\ Functions\end{tabular} & - \\
\end{tabular}%
}
\end{table}
...
\begin{table}[t]
\centering
\caption{Limitations of the current (open source) Knowledge Graph Construction engines}
\label{tab:soa_limitations_kgce}
\resizebox{\textwidth}{!}{%
...
RocketRML &
  ...
  RML (+FnO) &
  JavaScript &
  \begin{tabular}[c]{@{}c@{}}Memory consumption\\ in duplicates removal\end{tabular} \\ \hline
CARML &
  Materializer &
  RML (+FnO) &
  Java &
...
Chimera &
  Materializer &
  RML &
  \begin{tabular}[c]{@{}c@{}}Java\\ (extension of RMLMapper)\end{tabular} &
  Memory consumption \\ \hline
SPARQL-Generate &
  Materializer &
  SPARQL-Generate &
  Java &
...
COW &
  ...
  Scalability \\ \hline
Ontop &
  \begin{tabular}[c]{@{}c@{}}Materializer \&\\ Virtualizer\end{tabular} &
  \begin{tabular}[c]{@{}c@{}}R2RML\\ OBDA\end{tabular} &
  Java &
  Support for RDB \\ \hline
Morph-RDB &
  \begin{tabular}[c]{@{}c@{}}Materializer \&\\ Virtualizer\end{tabular} &
  R2RML &
  Java &
...
Squerall &
  ...
  RML (+FnO) &
  Java &
  \begin{tabular}[c]{@{}c@{}}Join Support\\ SPARQL operators\end{tabular} \\ \hline
Ontario &
  Virtualizer &
  RML &
  Python &
